    ...
    <>
      <section className="bg-white dark:bg-gray-900">
        <LayoutContainer>
          ...
          <img
            className="mt-10 h-64 w-full rounded-lg object-cover lg:h-96"
          ...
          <div className="mt-10 grid grid-cols-1 gap-12 sm:grid-cols-2 lg:grid-cols-3">
            <div className="rounded-lg bg-blue-50 p-4 md:p-6 dark:bg-gray-800">
            ...
            <div className="mt-8 lg:mx-6 lg:w-1/2">
              <div className="mx-auto w-full overflow-hidden rounded-lg bg-white px-8 py-10 shadow-2xl shadow-gray-300/50 lg:max-w-xl dark:bg-gray-900 dark:shadow-black/50">
                ...
                <form className="mt-6">
                  ...
                  <button className="focus:ring-opacity-50 mt-6 w-full transform rounded-md bg-blue-500 px-6 py-3 text-sm font-medium tracking-wide text-white capitalize transition-colors duration-300 hover:bg-blue-400 focus:ring focus:ring-blue-300 focus:outline-none">
                    get in touch
                  </button>
                </form>
              </div>
