export default function Auth() {
  return (
    <div className="h-screen w-full">
      <div className="m-auto flex w-full max-w-sm overflow-hidden rounded-lg bg-white shadow-lg lg:max-w-4xl dark:bg-gray-800">
        <div
        ...
        <div className="w-full px-6 py-8 md:px-8 lg:w-1/2">
          ...
          <div className="mt-4 flex items-center justify-between">
            ...
            <span className="w-1/5 border-b lg:w-1/4 dark:border-gray-400" />
          </div>
          <div className="mt-4">
            <label
